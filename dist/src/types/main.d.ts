import { ClickEventType } from './internal';
...
export type FilterOption = NumberFilterOption | StringFilterOption | ArrayFilterOption | CustomFilterOption | SimpleFilterOption;
